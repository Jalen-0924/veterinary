...
class PetBoarded extends BaseController
{
    public function index()
    {
		...
		return $this->render_template('doctor/pet/add_new',$data);
     ...
     public function view_all()
    {
		...
		return $this->render_template('doctor/pet/view_all',$data);
      ...
      public function edit($id = null)
    {
		...
		return $this->render_template('doctor/pet/edit',$data);
