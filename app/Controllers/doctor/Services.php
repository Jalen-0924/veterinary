...
class Services extends BaseController
{
    public function index()
    {
        ...
        return $this->render_template('doctor/services/add_new');
     ...
     public function view_all()
    {
        ...
        return $this->render_template('doctor/services/view_all',$data);
     ...
     public function edit($id = null)
    {
        ...
        return $this->render_template('doctor/services/edit',$data);
